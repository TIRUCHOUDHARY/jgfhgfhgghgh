...
<head>
    ...
    <meta property="og:url" content="https://a.picoapps.xyz/blue-same">

    <!-- Twitter Card tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="https://a.picoapps.xyz/blue-same">
...
<body class="bg-gray-100">
    ...
    <script>
        ...
        async function onGenerateButtonClick() {
            ...
            try {
                const response = await fetch("https://backend.buildpicoapps.com/aero/run/image-generation-api?pk=v1-Z0FBQUFBQm53YjktY0ZtbDRkeUxkb05vOU1wLTVDV2VvZFVMNUZNOW1MT3ItWWpxRTNVRUh0dnNQY05VeUg5VUFURFNmTnBCYl9qR0lVZ1dtMm0tTGxuV0w5cXNrUFkxSkE9PQ==", {
                    method: "POST",
                    headers: {
